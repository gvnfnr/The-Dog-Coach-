      ...
      <div className="max-w-7xl mx-auto px-4 pt-32 pb-16 space-y-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 py-16 border-y border-gray-200">
           {[
             ...
             { label: "AI Decision/Sec", value: "24.8k", icon: <img src="https://raw.githubusercontent.com/gvnfnr/The-Dog-Coach-/main/src/assets/ICONLOGO.png" alt="AI Icon" className="w-8 h-8 object-contain" style={{ filter: 'invert(1)' }} referrerPolicy="no-referrer" /> },
